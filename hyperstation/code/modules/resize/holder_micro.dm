...
/obj/item/clothing/head/mob_holder
	name = "bugged mob"
	desc = "A little creature held in your hand!"
	icon = null
	icon_state = ""
	var/mob/living/held_mob
	var/can_head = FALSE
	w_class = WEIGHT_CLASS_BULKY
	slot_flags = ITEM_SLOT_BELT | ITEM_SLOT_BACK | ITEM_SLOT_NECK | ITEM_SLOT_HEAD
...
/obj/item/clothing/head/mob_holder/examine(var/mob/user)
	for(var/mob/living/M in contents)
		M.examine(user)

/obj/item/clothing/head/mob_holder/MouseDrop(mob/M as mob)
	..()
	if(M != usr) return
	if(usr == src) return
...
/obj/item/clothing/head/mob_holder/attack_self(var/mob/living/user)
	for(var/mob/living/carbon/human/M in contents)
		M.help_shake_act(user)

/obj/item/clothing/head/mob_holder/attacked_by(obj/item/I, mob/living/user)
	for(var/mob/living/carbon/human/M in contents)
