/datum/species/human
	...
	mutant_bodyparts = list("ears", "tail_human", "wings", "taur", "deco_wings", "horns") // CITADEL EDIT gives humans snowflake parts
	default_features = list("mcolor" = "FFF", "mcolor2" = "FFF","mcolor3" = "FFF","tail_human" = "None", "ears" = "None", "wings" = "None", "taur" = "None", "deco_wings" = "None", "horns" = "None")
	use_skintones = 1
