...
//Bellies yo
#define BELLY_SIZE_A	0
#define BELLY_SIZE_B	1
#define BELLY_SIZE_C	2
#define BELLY_SIZE_D	3

#define BELLY_SIZE_MIN	BELLY_SIZE_A
#define BELLY_SIZE_DEF	BELLY_SIZE_A
#define BELLY_SIZE_MAX	BELLY_SIZE_D
